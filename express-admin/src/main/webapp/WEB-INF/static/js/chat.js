/* from D:\workhome\git\external-estate\src\js\al_md5.js */
/*
...
/* from D:\workhome\git\external-estate\src\js\Long.js */
/*
...
/* from D:\workhome\git\external-estate\src\js\ByteBufferAB.js */
/*
...
/* from D:\workhome\git\external-estate\src\js\ProtoBuf.js */
/*
 Copyright 2013 Daniel Wirtz <dcode@dcode.io>
...
/* from D:\workhome\git\external-estate\src\js\proto.js */
(function(WINDOW) {
    var Builder = dcodeIO.ProtoBuf.newBuilder({})['import']({
        "package": null,
        "messages": [
            {
                "name": "IMBusinessPacket",
                "fields": [
                    {
                        "rule": "required",
                        "type": "IMBusinessHeader",
                        "name": "bheader",
                        "id": 1
                    },
                    {
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {
                        "rule": "optional",
                        "type": "ReqDeleteMessage",
                        "name": "req_delete_message",
                        "id": 11
                    },
                    {
                        "rule": "optional",
                        "type": "ResultDeleteMessage",
                        "name": "delele_messge_result",
                        "id": 12
                    }
                ]
            },
            ...
            },
            {
                ...
                "fields": [
                    ...
                    },
                    {
                        "rule": "optional",
                        "type": "uint64",
                        "name": "exchange_msg_id",
                        "id": 19
                    },
                    {
                        "rule": "optional",
                        "type": "bytes",
                        "name": "exchange_mosaic_img_url",
                        "id": 20
                    },
                    {
                        "rule": "optional",
        ...
        "enums": [
            {
                ...
                "values": [
                    ...
                    {
                        "name": "TYPE_REQ_HISTORY",
                        "id": 6
                    },
                    {
                        "name": "TYPE_REQ_LATEST",
                        "id": 7
                    },
                    {
                        "name": "TYPE_RES_HISTORY",
                        "id": 8
                    },
                    {
                        "name": "TYPE_RES_LATEST",
                        "id": 9
                    },
                    {
                        "name": "TYPE_UNREAD_MSG",
                        "id": 10
                    },
                    {
                        "name": "TYPE_REQ_DEL",
...
/* from D:\workhome\git\external-estate\src\js\sf.js */
(function(WINDOW, $) {

    var debug = false;
    if (location.href.indexOf("cometbug=1") != -1) {
        debug = true;
    }
    ...
    var _SF;
    var _protoBuf = WINDOW.dcodeIO.ProtoBuf;
    var _byteBuffer = _protoBuf.ByteBuffer;
    var _MSG = WINDOW.Builder;
    //console.log(WINDOW);
    //console.log(WINDOW.Builder);

    // 把数据转化为buffer类型
    _SF = {
        _protoify: function(obj) {
            var utf8ToBuff = _byteBuffer.fromUTF8;

            var FUC = {
                // bytes in IMMsg: to buffer
                immsgToBuffer: function(msgObj) {
                    if(msgObj.fname !== undefined) {
                        msgObj.fname = utf8ToBuff(msgObj.fname);
                    }
                    if(msgObj.text !== undefined) {
                        msgObj.text = utf8ToBuff(msgObj.text);
                    }
                    if(msgObj.sender_head_url !== undefined) {
                        msgObj.sender_head_url = utf8ToBuff(msgObj.sender_head_url);
                    }
                    if(msgObj.img_main_url !== undefined) {
                        msgObj.img_main_url = utf8ToBuff(msgObj.img_main_url);
                    }
                    if(msgObj.img_large_url !== undefined) {
                        msgObj.img_large_url = utf8ToBuff(msgObj.img_large_url);
                    }
                    if(msgObj.exchange_mosaic_img_url !== undefined) {
                        msgObj.exchange_mosaic_img_url = utf8ToBuff(msgObj.exchange_mosaic_img_url);
                    }
                    if(msgObj.voice_url !== undefined) {
                        msgObj.voice_url = utf8ToBuff(msgObj.voice_url);
                    }
                    if(msgObj.rich_text !== undefined) {
                        msgObj.rich_text = utf8ToBuff(msgObj.rich_text);
                    }
                    if(msgObj.push_info !== undefined) {
                        msgObj.push_info = utf8ToBuff(msgObj.push_info);
                    }
                    if(msgObj.group_name !== undefined) {
                        msgObj.group_name = utf8ToBuff(msgObj.group_name);
                    }
                    if(msgObj.group_head_url !== undefined) {
                        msgObj.group_head_url = utf8ToBuff(msgObj.group_head_url);
                    }
                    return msgObj;
                },
                // bytes in IMBusinessPacket: to buffer
                businessToBuffer: function(msgObj) {
                    switch(msgObj.bheader.sub_type) {
                        // IMMsg
                        case 5:
                            if(msgObj.msg.msg === undefined) {
                                console.log("error: IMBusinessPacket中的枚举类型与内容不一致, 类型应为IMMsg.");
                                return;
                            }
                            msgObj.msg.msg = FUC.immsgToBuffer(msgObj.msg.msg);
                            break;
                        default:
                            // do nothing
                    }
            ...
            if(Object.prototype.toString.call(obj) !== "[object Object]") {
                if(debug) console.log( debug_time() + "The para isn't object" );
                return;
            }
            if(debug) console.log( debug_time() + "开始encode压缩数据" );
            // 1.bytes in obj.header: obj.header.encoding
            if(obj.header.encoding !== undefined) obj.header.encoding = _byteBuffer.fromUTF8(obj.header.encoding);
            else {
                obj.header.encoding = utf8ToBuff("protobuf");
            }
            // 2.bytes in obj.conetent: obj.content
            switch(obj.content.header.ptype) {
                case 0:
                    obj.content.content = (new _MSG.IMLoginPacket(obj.content.content)).toArrayBuffer();
                    break;
                case 2:
                    obj.content.content = (new _MSG.IMAuthPacket(obj.content.content)).toArrayBuffer();
                    break;
                case 4:
                    //obj.content.content = (new _MSG.IMHeartBeat(obj.content.content)).toArrayBuffer();
                    break;
                // 2.6 bytes in IMBusinessPacket
                case 6:
                    obj.content.content = FUC.businessToBuffer(obj.content.content);
                    obj.content.content = (new _MSG.IMBusinessPacket(obj.content.content)).toArrayBuffer();
                    break;
                // 2.9 TODO 群管理
                case 9:
                    break;
            ...
            obj.content = (new _MSG.IMDataPacket(obj.content)).toArrayBuffer();

            // 3.obj to toArrayBuffer
            obj = (new _MSG.IMPacket(obj)).encode();
            var dataLen = obj.byteLength || obj.limit;
            var headerBuffer = _byteBuffer.fromUTF8("IM");
            var lenBuffer = new ArrayBuffer(2);
            var dv = new DataView(lenBuffer);
            dv.setUint16(0, dataLen);
            obj = _byteBuffer.concat([headerBuffer,lenBuffer, obj]);
            obj = obj.toArrayBuffer();
            if(debug) console.log( debug_time() + "encode压缩数据完成" );
            return obj;
        },
        _jsonify: function(obj) {
            var FUC = {
                bufferToImsr: function(obj) {
                    obj.toid = obj.toid.toNumber();
                    obj.msgkey = obj.msgkey.toNumber();
                    obj.last_msg_key = obj.last_msg_key.toNumber();
                    obj.localid = obj.localid.toNumber();
                    obj.fromid = obj.fromid.toNumber();
                    if(obj.error_info !== undefined && obj.error_info !== null) obj.error_info = obj.error_info.toUTF8();
                    return obj;
                },
                bufferToImsn: function(obj) {
                    obj.to = obj.to.toNumber();
                    obj.from = obj.from.toNumber();
                    obj.maxid = obj.maxid.toNumber();
                    return obj;
                },
                bufferToImmsg: function(obj) {
                    //var obj = obj.toArrayBuffer();
                    //obj = _MSG.IMMsg.decode(obj);
                    obj.from = obj.from.toNumber();
                    obj.to = obj.to.toNumber();
                    if(obj.time !== undefined && obj.error_info !== null) {
                        obj.time = obj.time.toNumber();
                        // TODO 时间转换
                    }
                    if(obj.msgkey !== undefined && obj.msgkey !== null) obj.msgkey = obj.msgkey.toNumber();
                    if(obj.last_msgkey !== undefined && obj.last_msgkey !== null) obj.last_msgkey = obj.last_msgkey.toNumber();
                    if(obj.fname !== undefined !== obj.fname !== null) obj.fname = obj.fname.toUTF8();
                    if(obj.localid !== undefined && obj.localid !== null) obj.localid = obj.localid.toNumber();
                    if(obj.text !== undefined && obj.text !== null) obj.text = obj.text.toUTF8();
                    if(obj.sender_head_url !== undefined && obj.sender_head_url !== null) obj.sender_head_url = obj.sender_head_url.toUTF8();
                    if(obj.img_main_url !== undefined && obj.img_main_url !== null) obj.img_main_url = obj.img_main_url.toUTF8();
                    if(obj.img_large_url !== undefined && obj.img_large_url !== null) obj.img_large_url = obj.img_large_url.toUTF8();
                    if(obj.exchange_msg_id !== undefined && obj.exchange_msg_id !== null) obj.exchange_msg_id = obj.exchange_msg_id.toNumber();
                    if(obj.exchange_mosaic_img_url !== undefined && obj.exchange_mosaic_img_url !== null) obj.exchange_mosaic_img_url = obj.exchange_mosaic_img_url.toUTF8();
                    if(obj.voice_url !== undefined && obj.voice_url !== null) obj.voice_url = obj.voice_url.toUTF8();
                    if(obj.rich_text !== undefined && obj.rich_text !== null) obj.rich_text = obj.rich_text.toUTF8();
                    if(obj.push_info !== undefined && obj.push_info !== null) obj.push_info = obj.push_info.toUTF8();
                    if(obj.group_names !== undefined && obj.group_names !== null) obj.group_names = obj.group_names.toUTF8();
                    if(obj.group_head_url !== undefined && obj.group_head_url !== null) obj.group_head_url = obj.group_head_url.toUTF8();

                    return obj;
                },
                bufferToImHistroyResult: function(obj) {
                    obj.local_id = obj.local_id.toNumber();
                    if(obj.msg === undefined) console.log(debug_time() + "error: 服务器没返回历史消息回执无历史消息数据!");
                    else {
                        for(var i = 0, len = obj.msg.length; i < len; i++) {
                            obj.msg[i] = FUC.bufferToImmsg(obj.msg[i]);
                        }
                    }
                    return obj;
                },
                bufferToImLatestResult: function(obj) {
                    obj.local_id = obj.local_id.toNumber();
                    if(obj.msg === undefined) console.log(debug_time() + "error: 服务器没返回最新消息回执无最新消息数据!");
                    else {
                        for(var i = 0, len = obj.msg.length; i < len; i++) {
                            obj.msg[i] = FUC.bufferToImmsg(obj.msg[i]);
                        }
                ...
                bufferToImUnReadMsgs: function(obj) {
                    if(obj.msg === undefined) console.log(debug_time() + "error: 服务器没返回未读消息回执无未读消息数据!");
                    else {
                        for(var i = 0, len = obj.msg.length; i < len; i++) {
                            obj.msg[i] = FUC.bufferToImmsg(obj.msg[i]);
                        }
                ...
                bufferToResultDeleteMessage: function(obj) {
                    obj.rid = obj.rid.toNumber();
                    return obj;
                }
            };
            // TODO 判断前缀是否是IM
            var headerBuffer = obj.slice(0, 2);
            headerBuffer = _byteBuffer.wrap(headerBuffer);
            if(headerBuffer.toUTF8() !== "IM") {
                console.log(debug_time() + "收到的前两个字节不为IM");
            } else {
                if(debug) console.log(debug_time() + "开始decode解压数据:");
            }
            var obj = obj.slice(4);
            obj = _MSG.IMPacket.decode(obj);
            //console.log(obj);
            // 1. unit64 and bytes in header
            obj.header.routeid = obj.header.routeid.toNumber();
            obj.header.encoding = obj.header.encoding.toUTF8();
            // 2. unit64 and bytes in content
            obj.content = obj.content.toArrayBuffer();
            obj.content = _MSG.IMDataPacket.decode(obj.content);
            var _con = obj.content;
            // 2.1 unit64 and bytes in content.header
            if(_con.header.appid !== undefined) _con.header.appid = _con.header.appid.toNumber();
            if(_con.header.uid !== undefined) _con.header.uid = _con.header.uid.toNumber();
            // 2.2 unit64 and bytes in content.content
            _con.content = _con.content.toArrayBuffer();
            switch(_con.header.ptype) {
                // IMLogin
                case 0:
                    _con.content = _MSG.IMLoginPacket.decode(_con.content);
                    break;
                // IMLoginAck
                case 1:
                    _con.content = _MSG.IMLoginAck.decode(_con.content);
                    break;
                // IMAuthAck
                case 3:
                    _con.content = _MSG.IMAuthAck.decode(_con.content);
                    break;
                // IMHeartBeatAck
                case 5:
                    // do nothing
                ...
                // IMBusinessPacket
                case 6:
                    _con.content = _MSG.IMBusinessPacket.decode(_con.content);
                    switch(_con.content.bheader.sub_type) {
                        // IMSR 客户端发送消息回执 服务端发送给客户端(S-->C)
                        case 1:
                            _con.content.msg.sr = FUC.bufferToImsr(_con.content.msg.sr);
                            break;
                        // IMSN 状态同步，S-->C
                        case 4:
                            _con.content.msg.sn = FUC.bufferToImsn(_con.content.msg.sn);
                            break;
                        // IMMsg
                        case 5:
                            _con.content.msg.msg = FUC.bufferToImmsg(_con.content.msg.msg);
                            break;
                        // IMHistroyResult
                        case 8:
                            _con.content.msg.history_result = FUC.bufferToImHistroyResult(_con.content.msg.history_result);
                            break;
                        // IMLatestResult
                        case 9:
                            _con.content.msg.latest_result = FUC.bufferToImLatestResult(_con.content.msg.latest_result);
                            break;
                        // IMUnReadMsgs
                        case 10:
                            _con.content.msg.unread_msg = FUC.bufferToImUnReadMsgs(_con.content.msg.unread_msg);
                            break;
                        // ResultDeleteMessage
                        case 12:
                            _con.content.msg.delete_message_result = FUC.bufferToResultDeleteMessage(_con.content.msg.delete_message_result);
                            break;
                        default:
...
function getVisitor(visitor){
    ...
    return visitor + " " + ("000" + num).substr(num.toString().length);
}

/* from D:\workhome\git\external-estate\src\js\process.js */
window.onload = function() {
    ...
    var PROCESS = {
        Global: {
            isLogin: false, // 是否发送过登录包
            isSuccess: false, // 是否鉴权成功
            socket: undefined, // WebSocket对象
            random_str: undefined, // 登录收到的字符串，鉴权用
            sid: "", // 登录收到的sid，后面IMPacket.content.header.sid
            auth_result: false, // 鉴权收到的字符串
            token: localStorage.getItem("token") || "haha", // 链接的唯一标示 便于服务端识别链接对象
            fromid: localStorage.getItem("fromid") || Math.floor(Math.random()*10000), // TODO 用户id
            toid: localStorage.getItem("toid") || 100745, // TODO 接受人id
            localid: 0, // 本地维护的消息id
            last_msgkey: 0, // 维护收到的消息标示
            username: localStorage.getItem("username") || getVisitor("Visitor"), //Visitor random
            notSendedMsg: {},  //未建立连接时用户先点发送的消息
            notRecvMsg: {}, //未收到回执的
            userHead: "/static/images/demo/user2.png",
            ul: $(".chat ul")
        },
        md5: md5,
        protoify: SF._protoify,
        jsonify: SF._jsonify,
        // 发送登录消息
        login: function() {
            var msgLogin = {
                ...
                content: {
                    header: {
                        ptype: 0,
                        btype: 1234567,
                        sid: String(this.Global.sid),
                        uid: +this.Global.fromid,
                        dtype: 100,
                        appid: 1234567
                    },
                    content: {
                        userid: +this.Global.fromid,
                        sid: "",
                        c_fromid: +this.Global.fromid,
                        appid: "1234567",
                        version: "1.0",
                        mechanism: "NULL",
            ...
            if (this.Global.socket.readyState == WebSocket.OPEN) {
                var loginBuff = this.protoify(msgLogin);
                if(debug) console.log(debug_time() + "发送登录包:");
                if(debug) console.log(msgLogin);
                this.Global.socket.send(loginBuff);
                if(debug) console.log("发送登录包成功");
            }
        },
        // 发送鉴权消息
        auth: function() {
            var msgAuth = {
                ...
                content: {
                    ...
                    content: {
                        auth_str: this.md5(this.Global.random_str + "SKEY")
                    }
                }
            };
            //msgAuth.content.content.auth_str = this.md5(this.Global.random_str + "SKEY");
            if (this.Global.socket.readyState == WebSocket.OPEN && this.Global.isLogin) {
                var authBuff = this.protoify(msgAuth);
                if(debug) console.log(debug_time() + "发送鉴权:");
                if(debug) console.log(msgAuth);
                this.Global.socket.send(authBuff);
                if(debug) console.log("发送鉴权成功");
            }
        },
        // 发送心跳
        heart: function() {
            ...
            if (this.Global.socket.readyState == WebSocket.OPEN && this.Global.isSuccess) {
                var heartBuff = this.protoify(msgHeart);
                if(debug) console.log(debug_time() + "发送心跳:");
                if(debug) console.log(msgHeart);
                this.Global.socket.send(heartBuff);
            }
        },
        // TODO 发送消息请求
        sendMsg: function(sendContent, sendTime, localId) {
            var _self = PROCESS;
            var msgObj = {
                header: {
                    routeid: 0,
                ...
                content: {
                    header: {
                        ptype: 6,
                        btype: 1234567,
                        sid: _self.Global.sid,
                        uid: _self.Global.fromid,
                        dtype: 100,
                        appid: 1234567
                    },
                    content: {
                        ...
                        msg: {
                            msg: {
                                content_type: 1,
                                to: _self.Global.toid,
                                from: _self.Global.fromid,
                                msg_type: 1,
                                time: 0,
                                //msgkey: msgKey,
                                last_msgkey: _self.Global.last_msgkey,
                                fname: _self.Global.username,
                                localid: localId, // 发一条真实消息＋1
                                text: sendContent,
                                sender_head_url: _self.Global.userHead 
                                //exchange_flag exchange_msg_id TODO
                            }
                        }
                    }
                }
            ...
            var now = sendTime;
            var url = _self.Global.userHead;
            msgObj.content.content.msg.msg.time = now.getTime();
            msgObj.content.content.msg.msg.sender_head_url = url; // TODO 用户头像
            if(debug) console.log(debug_time() + "发送消息:");
            if(debug) console.log(msgObj);
            var msgBuff = _self.protoify(msgObj);
            _self.Global.socket.send(msgBuff);

        },
        //发送消息页面处理
        sendHandle: function(){
            var sendContent = $(".send p").text();
            if(!sendContent.length) return;
            var _self = PROCESS;
            var sendTime = new Date();
            _self.Global.localid++; // 当地的localid ＋ 1
            if (_self.Global.socket.readyState == WebSocket.OPEN && _self.Global.isSuccess) {
                PROCESS.sendMsg(sendContent, sendTime, _self.Global.localid);
            }
            //如果未成功连接，把消息先存起来，当建立连接后再一起发出去
            else{
                _self.Global.notSendedMsg[_self.Global.localid.toString()] = sendContent;
            }
            
            var node = $("<li>").addClass("text-right").attr("local-id", _self.Global.localid);
            //添加loading
            $("<span>").text(sendTime.toLocaleTimeString()).appendTo(node);
            $("<img>").attr({"src": "/static/images/download/loading.gif", "alt": "..."}).addClass("loading").appendTo(node);
            $("<p>").addClass("mine").text($(".send p").text()).appendTo(node);
            $("<img>").attr("src", _self.Global.userHead).appendTo(node); // TODO 用户头像
            node.appendTo($(".chat ul"));
            $(".send p").html(""); // 清空输入框的东西
            // TODO 假如用户发送消息需要回执的话，这里展示就要用。。。来表示发送中，当收到这条消息的回执后，把这个气泡去掉
            $('#chat .chat ul')[0].scrollTop = $('#chat .chat ul')[0].scrollHeight;
            window.scroll(0, 500);
        ...
        sendImdr: function() {
            var msgObj = {
                ...
                content: {
                    ...
                    content: {
                        ...
                        msg: {
                            dr: {
                                from: this.Global.fromid,
                                to: this.Global.toid,
                                msgkey: this.Global.last_msgkey,
                                chat_type: 1
                            }
                        }
                    }
            ...
            if(debug) console.log(debug_time() + "客户端发送接受消息回执:");
            if(debug) console.log(msgObj);
            if (this.Global.socket.readyState == WebSocket.OPEN && this.Global.isSuccess) {
                var msgBuff = this.protoify(msgObj);
                this.Global.socket.send(msgBuff);
            }
        },
        // 发送阅读消息回执(c->s)
        sendImrr: function() {
            ...
            if(debug) console.log(debug_time() + "客户端发送阅读消息回执:");
            if(debug) console.log(msgObj);
            if (this.Global.socket.readyState == WebSocket.OPEN && this.Global.isSuccess) {
                var msgBuff = this.protoify(msgObj);
                this.Global.socket.send(msgBuff);
        ...
        // TODO 发送拉取历史记录请求
        sendPullHistoryHandle: function() {
        },
        // TODO 发送拉取最新记录请求
        sendPullLatestHandle: function() {
        },
        // TODO 发送删除记录请求
        sendDeleteHandle: function() {
        },
        // 收到消息响应
        msgHandle: function(obj) {
            switch(obj.content.header.ptype) {
                // 登录响应（s->c）
                case 1:
                    if(this.Global.isLogin || this.Global.isSuccess) return;
                    else if(this.Global.socket.readyState == WebSocket.OPEN) {
                        if(debug) console.log(debug_time() + "收到登录响应:");
                        if(debug) console.log(obj);
                        this.Global.random_str = obj.content.content.random_str;
                        this.Global.sid = obj.content.content.sid;
                ...
                // 鉴权响应（s->c）
                case 3:
                    if(!obj.content.content.auth_result) return;
                    else if(this.Global.socket.readyState == WebSocket.OPEN) {
                        if(!this.Global.isLogin) {
                            this.login();
                        } else if(obj.content.content.auth_result === "auth success") {
                            if(debug) console.log(debug_time() + "收到鉴权响应, 鉴权成功:");
                            if(debug) console.log(obj);
                            this.Global.isSuccess = true;
                            //发送初始化时，保存的未送的消息
                            PROCESS.sendNotSendMsg();
                        } else {
                            console.log(debug_time() + "error: 鉴权失败, 请确认鉴权!");
                        }
                    }
                    break;
                // 心跳响应（s->c）
                case 5:
                    isSuccess = true;
                    if(debug) console.log(debug_time() + "收到心跳响应:");
                    break;
                // 收到消息（s->c）
                case 6:
                    var node = $("<li>");
                    var now = new Date();
                    var url = this.Global.userHead;
                    switch(obj.content.content.bheader.sub_type) {
                        // 客户端发送消息后 服务端发送给客户端的回执(S-->C)
                        case 1:
                            // 更新last_msg_key
                            this.Global.last_msgkey = obj.content.content.msg.sr.msgkey;
                            if(debug) console.log(debug_time() + "收到服务端消息回执:");
                            if(debug) console.log(obj);
                            //把有气泡的发送样式去掉
                            var localid = "[local-id='" + obj.content.content.msg.sr.localid + "']";
                            this.Global.ul.children(localid).find(".loading").remove();
                            break;
                        // TODO 状态同步，S-->C
                        case 4:
                            if(debug) console.log(debug_time() + "收到服务端状态同步:");
                            if(debug) console.log(obj);
                            // TODO 判断状态同步是否count字段>0,拉取最新消息:1.当前不是阅读状态,否的话红泡展示2.是阅读状态，直接放在阅读窗口
                            break;
                        case 5:
                            // 1.验证是否是刚好那一条按顺序要收到的消息
                            if(debug) console.log(debug_time() + "收到服务端消息:");
                            if(debug) console.log(obj);
                            if(this.Global.last_msgkey !==0 && this.Global.last_msgkey !== obj.content.content.msg.msg.last_msgkey) {
                                console.log(debug_time() + "收到鉴权响应不为顺序收到的:");
                            }
                            // 2.更新聊天窗口样式 更新last_msg_key等状态
                            this.Global.last_msgkey = obj.content.content.msg.msg.last_msgkey;
                            $("<span>").text(now.toLocaleTimeString()).appendTo(node);
                            $("<img>").attr("src", url).appendTo(node); // TODO 用户头像
                            $("<p>").text(obj.content.content.msg.msg.text).appendTo(node);
                            node.appendTo($(".chat ul"));
                            $('#chat .chat ul')[0].scrollTop = $('#chat .chat ul')[0].scrollHeight;
                            // 3.发送接受消息回执 IMDR
                            this.sendImdr();
                        ...
                        // 拉取历史消息回应
                        case 8:
                            if(debug) console.log(debug_time() + "拉取历史消息回应:");
                            if(debug) console.log(obj);
                            break;
                        // 拉取最新消息回应
                        case 9:
                            if(debug) console.log(debug_time() + "拉取最新消息回应:");
                            if(debug) console.log(obj);
                            break;
                        // 未读消息（s->c）
                        case 10:
                            if(debug) console.log(debug_time() + "未读消息:");
                            if(debug) console.log(obj);
                            break;
                        // 删除消息回应
                        case 12:
                            if(debug) console.log(debug_time() + "删除消息回应:");
                            if(debug) console.log(obj);
                            break;
                        default:
                ...
                case 9:
                    // TODO 讨论组消息
                    if(debug) console.log(debug_time() + "讨论组消息:" + obj);
                    break;
                default:
        ...
        eventListen: function() {
            ...
            global.socket.onmessage = function(evt) {
                var obj = PROCESS.jsonify(evt.data);
                PROCESS.msgHandle(obj);
                //console.log(evt.data);
            };

        },
        //建立连接后，将之前用户点发送的消息发出去
        sendNotSendMsg: function(){
            var sendTime = new Date();
            var msgs = PROCESS.Global.notSendedMsg;
            for(var key in msgs){
                PROCESS.sendMsg(msgs[key], sendTime, key);
            }
            PROCESS.Global.notSendedMsg = null;
        },
        init: function() {
            var tryConnTime = 0;
            PROCESS.Global.socket = new WebSocket("ws://ec2-52-89-184-198.us-west-2.compute.amazonaws.com:25025");
//            this.Global.socket = new WebSocket("ws://10.4.32.133:25025");
            //this.Global.socket = new WebSocket("ws://localhost:8080/ws");
                PROCESS.Global.socket.binaryType = "arraybuffer"; // We are talking binary
                PROCESS.Global.socket.onopen = function() {
                    PROCESS.eventListen();
                    PROCESS.login();
                };
                PROCESS.Global.socket.onerror = function(){
                    tryConnTime++;
                    console.log("连接服务器失败" + tryConnTime + "次");
                    if(tryConnTime > 5){
                        if(debug) console.log("连接服务器失败超过5次");
                        return;
                    }
                    PROCESS.Global.socket = new WebSocket("ws://ec2-52-89-184-198.us-west-2.compute.amazonaws.com:25025");
                };
            $(".send p").focus();
            // 给input增加点击事件
            $(".sendbtn").on("click", this.sendHandle);
    ...
    !function init2(){
        ...
        function setBorderLeft(){
            var style = window.getComputedStyle($(".wrapper")[0], null);
            $(".home_c .border").css({"left": (parseInt(style.marginLeft) - 2) + "px", display: "block"});
        } 
        setTimeout(setBorderLeft, 100);
        $(window).on("resize", setBorderLeft);
    }();
};

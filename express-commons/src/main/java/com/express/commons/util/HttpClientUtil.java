...
public class HttpClientUtil {
    ...
    public static String doGet(String url, Map<String, String> params) {
        ...
        try{
            ...
            if(response.getStatusLine().getStatusCode() == 200) {
                ...
                LOG.error("HttpClientUtil.doGet.ERROR responseStatus = "+response.getStatusLine().getStatusCode());
            }
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        ...
        String sql = "select COALESCE(sum(duration),0)  from vcall_stat  where dialer_call_record_id in (select id from dialer_call_record where user_id =#{userId} and create_time between #{beginTime} and #{endTime})";
